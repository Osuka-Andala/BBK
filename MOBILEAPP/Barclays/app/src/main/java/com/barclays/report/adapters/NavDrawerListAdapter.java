...
public class NavDrawerListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView txtDesc = (TextView) convertView.findViewById(R.id.subTitle);

		TextView txtCount = (TextView) convertView.findViewById(R.id.counter);

		imgIcon.setImageResource(navDrawerItems.get(position).getIcon());

		txtTitle.setTypeface(Fonting.getFont(parent.getContext(),
				Fonting.KEY_LIGHT));

		txtTitle.setText(navDrawerItems.get(position).getTitle().toUpperCase());
		txtDesc.setText(navDrawerItems.get(position).getDesc().toUpperCase());
