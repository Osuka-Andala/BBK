...
public class BitmapScaler {
    ...
    public void roughScaleImage(InputStream is, Size size) {
        Matrix matrix = new Matrix();
    ...
    public void roughScaleImage(Resources resources, int resId, Size size) {
        Matrix matrix = new Matrix();
        matrix.postScale(size.scale, size.scale);
    ...
    public Size getRoughSize(InputStream is, int newWidth) {
    ...
    public Size getRoughSize(Resources resources, int resId, int newWidth) {
        BitmapFactory.Options o = new BitmapFactory.Options();
        o.inJustDecodeBounds = true;
    ...
    public String getBase64String() {
        ...
        scaled.compress(CompressFormat.JPEG, 100, bos);
        String encoded = Base64.encodeBytes(bos.toByteArray());

        return encoded;
    }

    public Size getRoughSize(int outWidth, int outHeight, int newWidth) {
        Size size = new Size();
