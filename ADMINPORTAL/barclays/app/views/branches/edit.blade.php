...
<h3 class="page-title">
   Branches <small>modify</small>
</h3>
<!-- END PAGE HEADER-->
<div class="portlet box blue">
   <div class="portlet-title">
      <div class="caption">
         <i class="fa fa-gift"></i> modify branches details
      </div>
      <div class="tools">
   ...
   <div class="portlet-body form">
      <!-- BEGIN FORM-->
      {{ Form::model($branches, array('route' => array('branches.update', $branches->id), 'method' => 'PUT')) }}
      <div class="form-body">
      ...
      <div class="form-actions right">
         ...
         {{ Form::submit('update branch', array('class' => 'btn btn-outline btn-primary')) }}
      </div>
      {{ Form::close() }}
      <!-- END FORM-->
   </div>
