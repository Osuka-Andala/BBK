...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Usalama Kenya Portal</title>
...
<li>
    ...
    <ul class="sub-menu">
        ...
        <li>
            <a href="{{ URL::to('personas') }}">
                <i class="icon-list"></i>
                suspicious persons</a>
        </li>

        <li>
            <a href="{{ URL::to('vehicles') }}">
                <i class="icon-list"></i>
                suspicious vehicles</a>
        </li>

        <li>
            <a href="{{ URL::to('incidents') }}">
                <i class="icon-list"></i>
                suspicious incidents / occurences</a>
        </li>

        <li>
            <a href="{{ URL::to('places') }}">
                <i class="icon-list"></i>
                suspicious places / areas</a>
        </li>
...
<li >
    <a href="{{ URL::to('dashboardAnalytics/') }}">
        <i class="icon-users"></i>
...
<li>
    ...
    <ul class="sub-menu">
        ...
        <li>
            <a href="{{ URL::to('requests') }}">
                <i class="icon-list"></i>
                create alert</a>
        </li>
        <li>
            <a href="{{ URL::to('requests/create') }}">
                <i class="icon-list"></i>
                all alerts</a>
        </li>
...
<div class="page-footer">
    <div class="page-footer-inner">
        2015 &copy; Fravier Innovate by Fravier Limited
    </div>
