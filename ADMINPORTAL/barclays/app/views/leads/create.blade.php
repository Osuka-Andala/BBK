...
<div class="page-bar">
   <ul class="page-breadcrumb">
      ...
      <li>
         <a href="{{ URL::to('personas/') }}">leads</a>
         <i class="fa fa-angle-right"></i>
      </li>
      <li>
         <a href="#">new</a>
...
<h3 class="page-title">
   Leads <small>add new</small>
</h3>
<!-- END PAGE HEADER-->
<div class="portlet box blue">
   <div class="portlet-title">
      <div class="caption">
         <i class="fa fa-gift"></i> add new lead details
      </div>
      <div class="tools">
   ...
   <div class="portlet-body form">
      <!-- BEGIN FORM-->
      {{ Form::open(array('route' => array('leads.index'),'class'=>'horizontal-form ')) }}
      <div class="form-body">
      ...
      <div class="form-actions right">
         ...
         {{ Form::submit('save lead', array('class' => 'btn btn-outline btn-primary')) }}
      </div>
      {{ Form::close() }}
      <!-- END FORM-->
   </div>
