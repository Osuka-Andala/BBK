...
<div class="page-bar">
   <ul class="page-breadcrumb">
      ...
      <li>
         <a href="{{ URL::to('personas/') }}">branches</a>
         <i class="fa fa-angle-right"></i>
      </li>
      <li>
         <a href="#">new</a>
...
<h3 class="page-title">
   Branches <small>add new</small>
</h3>
<!-- END PAGE HEADER-->
<div class="portlet box blue">
   <div class="portlet-title">
      <div class="caption">
         <i class="fa fa-gift"></i> add new branch details
      </div>
      <div class="tools">
   ...
   <div class="portlet-body form">
      <!-- BEGIN FORM-->
      {{ Form::open(array('route' => array('branches.index'),'class'=>'horizontal-form ')) }}
      <div class="form-body">
         ...
         <div class="row">
            <div class="col-md-6">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  {{ Form::label('manager', 'Branch Manager') }}
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  {{ Form::label('telephone', 'Branch Contact Information') }}
      ...
      <div class="form-actions right">
         ...
         {{ Form::submit('save branch', array('class' => 'btn btn-outline btn-primary')) }}
      </div>
      {{ Form::close() }}
      <!-- END FORM-->
   </div>
